...
bank_raw = load_data(
    file_data='https://raw.githubusercontent.com/tarcisioalmeidabh/ebac_cientista_de_dados/main/M%C3%B3dulo%2019%20-%20Streamlit%20II/Exerci%CC%81cio_1/data/bank-additional-full.csv', sep=';')
bank = bank_raw.copy()
